...
Due to the fact our approach is based on the existing office located in Chicago, hence it is highly related to the infrastructures of the office upon which we build our model including internal
